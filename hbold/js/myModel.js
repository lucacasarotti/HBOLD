...
//    	var inx=getClassInxByClassParam(param);
    ...
    getChilds : function(index){
    	...
    	var curNo = _.find(this.curQCN,function(a){return a.index==index})
    	var lev1Childs = _.compact(_.map(this.curQCN,function(a){if(a.qoQI==curNo.index)return a}))
...
//    	_.each(lev1Childs,function(a){if(!this.isNodeLeaf(a.param))childs.concat(this.getChilds(a.index))})
    ...
    getLevel1Child :function(index){
		console.log("entrato in getLevel1Child")
    	var curNo = _.find(this.curQCN,function(a){return a.index==index})
    	var lev1Childs = _.compact(_.map(this.curQCN,function(a){if(a.qoQI==curNo.index)return a.index}))
    	return lev1Childs;
    },
